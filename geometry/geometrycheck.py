...
# ==============================================================================
# 2. CREATE A SINGLE POINT (IMPULSE)
# ==============================================================================
# Empty image (ASTRA expects data in row, col order i.e. Z, X here)
...
vol_data[z_idx, x_idx] = 1.0  # The single bright point
...
# ==============================================================================
# 4. THEORETICAL MATHEMATICAL CALCULATION (THALES / VECTOR INTERSECTION)
# ==============================================================================
...
for theta in angles:
    ...
    hit_pixel = (hit_x_mm - (-det_col_count * det_pixel_size / 2.0)) / det_pixel_size
